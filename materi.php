...
<html lang="en">
	...
	<body>
		...
		<div class="topnav">
  		...
  		<a class="active" href="materi.php">Materi</a>
		...
		<div id="panel">
			...
			<div id="content">
			<a button class="accordtab" href="file/materi/Gugus Fungsi.pdf" target="iframe_a">Gugus Fungsi</a><br>
			<a button class="accordtab" href="file/materi/Alkanol.pdf" target="iframe_a">Alkanol</a><br>
			<a button class="accordtab" href="file/materi/Alkoksialkana.pdf" target="iframe_a">Alkoksialkana</a><br>
			<a button class="accordtab" href="file/materi/Alkanal.pdf" target="iframe_a">Alkanal</a><br>
			<a button class="accordtab" href="file/materi/Alkanon.pdf" target="iframe_a">Alkanon</a><br>
			<a button class="accordtab" href="file/materi/Asam alkanoat.pdf" target="iframe_a">Asam Alkanoat</a><br>
			<a button class="accordtab" href="file/materi/Alkil alkanoat.pdf" target="iframe_a">Alkil Alkanoat</a><br>
			</div>
		</div>
