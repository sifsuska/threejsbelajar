	 ...
	 //adding html for submit button
		$m_output .= '  <tr>
							<td colspan="2" align="center">
								<span id="m_btnSpan">
									<a href="javascript:{}" onclick="quiz_submit()" class="myButton">Kirim Jawaban</a>
								</span>
							</td>
						</tr>';
	     ...
	     //function that keeps the counter going
			function timer(secs){
				...
				if(mins_rem<10 && secs_rem>=10)
					ele.innerHTML = "Waktu tersisa: "+"0"+mins_rem+":"+secs_rem;
				else if(secs_rem<10 && mins_rem>=10)
					ele.innerHTML = "Waktu tersisa: "+mins_rem+":0"+secs_rem;
				else if(secs_rem<10 && mins_rem<10)
					ele.innerHTML = "Waktu tersisa: "+"0"+mins_rem+":0"+secs_rem;
				else
					ele.innerHTML = "Waktu tersisa: "+mins_rem+":"+secs_rem;
